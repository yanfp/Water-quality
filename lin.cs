...
{
    public partial class lin : DevExpress.XtraEditors.XtraForm
    {
        public IMap m_pMap;
        public lin()
        {
        ...
        private void lin_Load(object sender, EventArgs e)
        {
        ...
        private void bt_OK_Click(object sender, EventArgs e)
        {
            ...
            oComIDL.ExecuteString(".compile '" + System.IO.Directory.GetCurrentDirectory() + @"\ling.pro'");
