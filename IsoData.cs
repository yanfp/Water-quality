...
{
    public partial class IsoData : DevExpress.XtraEditors.XtraForm
    {
        List<string> IsoName = new List<string>();
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            else if (dmudMinClass.ToString() == "" || dmudNumClass.ToString() == "" || dmudMinPiexls.ToString() == "" || dmudIterations.ToString() == "")
            {
                MessageBox.Show("参数设置为空，请重新设置参数！", "提示", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                return;
            }
            ...
            else
            {
                ...
                string str = ".compile '" + Application.StartupPath + "\\RSImage_Isodata.pro" + "'";
                ...
                string str1 = "RSImage_Isodata" + ",'" + inputfile + "'" + "," + pos + ",'" + txtbOutput.Text + "'" + ",4,'" + dmudMinClass.Text + "'" + ",'" + dmudNumClass.Text + "'" + ",'" + dmudIterations.Text + "'" + ",'" + txtChangeThresh.Text + "'" + ",'" + dmudMinPiexls.Text + "'" + ",'" + txtMaxClassStd.Text + "'" + ",'" + txtMinClassDist.Text + "'" + ",'" + dmudMaxMergePiexls.Text + "'";
